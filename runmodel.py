...
def setupEnvironment(ui_input=None):
	...
	for c in to_run:
		...
		path_entries = ['yearset','HourlyLoadFile','PRMregion_file','PRMstate_file','FuelLimit_file','FuelPrice_file','TechCost_file','MinLoad_file','Hours_file','Load_file','PeakDemRegion_file','PeakDemState_file','IVT_file','Trancap_file', 'Trancost_file','InterTrancost_file', 'AbsGrowLim_file', 'CapNonRsc_file', 'CapRsc_file', 'PrescribedNonRsc_file', 'PrescribedRsc_file', 'CfOut_file', 'RscDat_file']
